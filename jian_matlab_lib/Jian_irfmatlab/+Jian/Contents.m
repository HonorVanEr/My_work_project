...
%   e_vxb               - Calculates E = vxB/ne. 
%   fast_date           - Returns a date string
%   fci                 - Finds relevant index of a vector
%   figmenu             - Helpful menu items.
...
%   linelength          - Calculate the length of a line.
...
%   triangle            - Plots triangles.

%   Marker              - Class for storing shapes.
